...
Route::middleware('setLanguage')->group(function () {
    ...
    Route::get('/contato', [EnquiryController::class, 'contactUs'])->name('contato');
    Route::get('/sobre', [Web\WebController::class, 'aboutUs'])->name('sobre');
    Route::post('/book-appointment', [Web\WebController::class, 'bookAppointment'])->name('book-appointment');
    Route::get('/agendamento', [Web\WebController::class, 'appointment'])->name('agendamento');
    Route::post('/appointment-form', [Web\WebController::class, 'appointmentFromOther'])->name('appointment.post');
    Route::get('/servicos', [Web\WebController::class, 'services'])->name('our-services');
    Route::get('/medicos', [Web\WebController::class, 'doctors'])->name('medicos');
    Route::get('/termos-servicos', [Web\WebController::class, 'termsOfService'])->name('termos-servicos');
    Route::get('/politica-privacidade', [Web\WebController::class, 'privacyPolicy'])->name('politica-privacidade');
    Route::get('/jornada-trabalho', [Web\WebController::class, 'workingHours'])->name('jornada-trabalho');
    Route::get('/testemunhos', [Web\WebController::class, 'testimonials'])->name('testemunhos');
});

<?php
// Settings file for HESK 3.4.3

// ==> GENERAL

// --> General settings
$hesk_settings['site_title']='My Web site';
$hesk_settings['site_url']='https://verticos.com.br';
$hesk_settings['hesk_title']='My help desk';
$hesk_settings['hesk_url']='https://verticos.com.br/desk';
$hesk_settings['webmaster_mail']='admin@verticos.com.br';
...
$hesk_settings['language']='Português';
$hesk_settings['languages']=array(
'Português' => array('folder'=>'pt','hr'=>'------ Responder acima desta linha ------'),
'English' => array('folder'=>'en','hr'=>'------ Reply above this line ------'),
);

// --> Database settings
$hesk_settings['db_host']='localhost';
$hesk_settings['db_name']='verti579_hesk796';
$hesk_settings['db_user']='verti579_hesk796';
$hesk_settings['db_pass']='!Tn7O6S6p[';
$hesk_settings['db_pfix']='heskd8_';
...
$hesk_settings['secimg_sum']='2XRE8U1UX7';
...
$hesk_settings['url_key']='Zg99gaJPQqxUrX13B5bkS';
...
// --> Email sending
$hesk_settings['noreply_mail']='admin@verticos.com.br';
...
// --> Date & Time
$hesk_settings['timezone']='America/New_York';
...
#     DO NOT EDIT BELOW     #
#############################
$hesk_settings['hesk_version']='3.4.3';

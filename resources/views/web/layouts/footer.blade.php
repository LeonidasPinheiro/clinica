        ...
        <div class="row justify-content-between">
            ...
            <div class="col-lg-2 col-md-6 mb-3">
                ...
                <ul class="ps-0">
                    ...
                    <li>
                        <a href="{{ route('medicos') }}" class="{{ Request::is('medicos') ? 'footer-active' : '' }} text-decoration-none mb-3 d-block text-white">
                            {{ __('messages.web_home.doctors') }}
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('sobre') }}" class="{{ Request::is('sobre') ? 'footer-active' : '' }} text-decoration-none mb-3 d-block text-white">
                            {{ __('messages.web_menu.about') }}
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('contato') }}" class="{{ Request::is('contato') ? 'footer-active' : '' }} text-decoration-none mb-3 d-block text-white">
